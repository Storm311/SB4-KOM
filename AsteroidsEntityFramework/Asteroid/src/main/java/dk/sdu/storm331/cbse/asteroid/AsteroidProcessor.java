package dk.sdu.storm331.cbse.asteroid;
...
public class AsteroidProcessor implements IEntityProcessingService {
    ...
    private IAsteroidSplit asteroidSplitter = new AsteroidSplit();
    ...
    public void process(GameData gameData, World world) {
        ...
        for (Entity asteroid : world.getEntities(Asteroid.class)) {
            ...
            // Split event
            if (lifePart.isHit()) {
                asteroidSplitter.createAsteroidSplit(asteroid, world);
            }
     ...
     */
    public void setAsteroidSplitter(IAsteroidSplit asteroidSplitter) {
        this.asteroidSplitter = asteroidSplitter;
    }

    public void removeAsteroidSplitter(IAsteroidSplit asteroidSplitter) {
